...
curvesR<- df %>% group_by(orientation,stream,subject) %>% 
...
#make duplicate of data, one for R column, one for MATLAB (data identical)
...
sz=.8
#I need to plot the underlying Gaussian, not the discretized Gaussian
