...
plotHistWithFit(dAI,minSPE,maxSPE,dAI$targetSP,numItemsInStream,plotContinuousGaussian)
```
...
plotHistWithFit(dAI12,minSPE,maxSPE,dAI$targetSP,numItemsInStream,plotContinuousGaussian)
```
